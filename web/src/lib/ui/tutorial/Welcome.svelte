...
{#if !tourInProgress && $account.state === 'Connected' && !$account.isLoadingData && !hasCompletedTutorial($offchainState.tutorial.progression, TUTORIAL_STEP.WELCOME)}
	<Modal {onclosed}>
		<div class="content">
			<p>
				Welcome my divine soul, to the world of Stratagems. You are a powerful being able to shape it, but be careful as
				you use your power ({initialContractsInfos.contracts.Stratagems.linkedData.currency.symbol}), others will not
	...
	<Modal>
		<div class="content">
			{#if defaultRPC}
				...
				<p>
					In order to play this game, you need to connect to a web3 wallet like <a href="https://metamask.o">Metamask</a
					>
				</p>
